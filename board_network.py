...
def create_game_network():
    """
    Implements the underlying network of the game.
    """
    ...
    # Assigne les catégories aux noeuds du graphe
    for idx in range(73):
        G.nodes[idx]['box_type'] = INDEX_TO_BOX_TYPE[idx]

    return G


structure = create_game_network()
print("Done")
